          ...
          <div class="col-lg-10 col-xl-9 mx-auto">
            <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
              ...
              <div class="card-body p-4 p-sm-5">
                <h3 class="card-title text-center fs-5" style="color: #1ac561; font-weight:600">QUẢN TRỊ VIÊN</h3>
                <h5 class="card-title text-center mb-5 fw-light fs-5">Đăng nhập</h5>
                <form action="<?= DOCUMENT_ROOT ?>/admin/accounts/signin" method="POST">
                  ...
                  <!-- <a class="d-block text-center mt-2 small" href="">Bạn đã là thành viên chưa? Đăng ký</a> -->
                </form>
              </div>
            </div>
          </div>
