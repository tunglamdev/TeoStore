...
<section class="content">
      ...
      <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php DOCUMENT_ROOT ?>/admin/products/store" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="weight" name="weight"  placeholder="Nhập khối lượng sản phẩm" required>
                            </div>
                            <div class="form-group">
